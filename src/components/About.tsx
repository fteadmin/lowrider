    ...
    <section id="about" className="min-h-screen flex items-center py-20 bg-gradient-to-b from-black to-zinc-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-16 flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link to="/wla-association" className="px-8 py-4 bg-gradient-to-r from-[#D9BA84] to-[#CCB550] text-[#031100] font-bold rounded-lg hover:from-[#CCB550] hover:to-[#DCBD84] transform hover:scale-105 transition-all shadow-lg shadow-[#D9BA84]/50">
            WLA Membership
          </Link>
          <Link to="/wealth-legacy" className="px-8 py-4 border-2 border-[#D9BA84] text-[#D9BA84] font-bold rounded-lg hover:bg-[#D9BA84] hover:text-[#031100] transition-all">
